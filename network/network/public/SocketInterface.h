...
// 		if (!pData)		copy(src->pData, len);
// 		BYTE* pTmp = new BYTE[Length + len];
// 		memcpy(pTmp, pData, Length);
// 		memcpy(pTmp + Length, src->pData, len);
// 		memcpy(src->pData, src->pData + len, src->Length - len);
// 		delete[] pData;
// 		pData = pTmp;
// 		Length += len;
// 		src->Length -= len;
