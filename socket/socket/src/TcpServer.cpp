...
BOOL CTcpServer::Start(const char* lpszBindAddress, unsigned short usPort)
{
...
BOOL CTcpServer::CreateListenSocket(const char* lpszBindAddress, unsigned short usPort)
{
	BOOL isOK = FALSE;
...
// BOOL CTcpServer::StartDataThread(){
// 	BOOL isOK = TRUE;
// 	
